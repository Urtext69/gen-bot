...
bot.on("message", async message => {	
    ...
    if (command === "gen") {	
        if(message.channel.id !== "801824839878180894") return message.channel.send("This command can be runned only in the generate channel")	
            ...
            let account = JSON.parse(data)	
                ...
                const embed = {	
                    ...
                    footer: {	
                        ...
                        text: "Buy discord bots from Orphan Obliterator#0001"	
                    },	
                    thumbnail: {	
                        url:	
